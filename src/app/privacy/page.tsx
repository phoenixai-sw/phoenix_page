...
export const metadata: Metadata = { title: "개인정보처리방침 | phoenix detail page" };

export default function PrivacyPage() {
  return (
    <LegalPage title="개인정보처리방침" updated="2026-07-28">
      <section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>학습용 서비스 운영·관리 (저장 한도 적용, 보존 기간 관리 등)</li>
        </ul>
      </section>
      <section>
        <h2>3. 보유 및 파기</h2>
        <ul>
          <li>클라우드에 저장된 프로젝트와 업로드 원본은 마지막 수정일로부터 7일이 지나면 자동 삭제됩니다.</li>
      ...
      <section>
        ...
        <p>PhoenixAI · phoenixai.sw@gmail.com</p>
      </section>
      <section>
        <h2>7. 고지</h2>
        <p>이 방침은 2026-07-28부터 적용되며, 내용 변경 시 서비스 내 공지로 알립니다.</p>
      </section>
    </LegalPage>
  );
}
